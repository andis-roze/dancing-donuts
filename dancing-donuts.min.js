...
var AbstractDonutContainer = /** @class */ (function () {
    ...
    AbstractDonutContainer.prototype.initDonutState = function () {
        for (var x = 0; x < this.donutCountX; x++) {
            ...
            for (var y = 0; y < this.donutCountY; y++) {
                ...
                var endAngle = startAngle + Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getRandomArbitrary"])(Math.PI / 2, 1.75 * Math.PI);
    ...
    AbstractDonutContainer.prototype.isDonutHit = function (donutState, clickCoords) {
        var center = donutState.center, rotationAngle = donutState.rotationAngle;
        var startAngle = donutState.startAngle, endAngle = donutState.endAngle;
        startAngle = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["reduceAngle"])(startAngle + rotationAngle);
        startAngle = startAngle < 0 ? startAngle + 2 * Math.PI : startAngle;
        endAngle = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["reduceAngle"])(endAngle + rotationAngle);
        ...
        var startIsBigger = startAngle > endAngle;
